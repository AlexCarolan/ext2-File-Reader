...
>
>Files up to the maximum size for 1K blocks can be read however, files using triple-indirect pointers will take longer to read due to the large number of pointers being accessed.
